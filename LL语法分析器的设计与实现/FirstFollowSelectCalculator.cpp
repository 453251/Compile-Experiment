...
map<string, set<string>> FirstFollowSelectCalculator::getFirstSets()
{
	return firstSets;
}

map<string, set<string>> FirstFollowSelectCalculator::getFollowSets()
{
	return followSets;
}

map<Production, set<string>> FirstFollowSelectCalculator::getSelectSets()
{
	return selectSets;
}
